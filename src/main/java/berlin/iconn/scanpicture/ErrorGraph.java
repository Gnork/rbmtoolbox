...
/**
 * Created by GDur on 15.05.14.
 */
public class ErrorGraph extends JComponent implements IVisualizeObserver {
    ...
    public ErrorGraph(FloatMatrix data, int rbmEdgeLength) {
