 ...
 */
public class BatchTrainingLabDataProvider extends ATrainingDataProvider {
    ...
    public BatchTrainingLabDataProvider(FloatMatrix data, int batchCount) {
        super(data);
    ...
    public BatchTrainingLabDataProvider(float[][] data, int batchSize){
